  ...
  return (
    <div className="min-h-screen bg-background pb-20 md:pb-0">
      ...
      <div className="pt-[96px] lg:pt-[172px]">
        ...
        <div className={`container mx-auto px-10 pb-12 md:pb-20 ${hasFeaturedSubcategories ? "" : "pt-8 md:pt-12"}`}>
          ...
          {!hasFeaturedSubcategories ? renderProductList() : (
